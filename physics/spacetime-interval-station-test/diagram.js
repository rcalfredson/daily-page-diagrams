(function (root, factory) {
  ...
  const COPY = {
    ...
    ru: {
      title: "Проверка пространственно-временного интервала на станции",
      description:
        "Числовая диаграмма пространства-времени: по горизонтали отложено положение, а время возрастает вверх. Сигнал испускается в нуле километров и нуле секунд. Мировая линия неподвижной станции вертикальна и находится на расстоянии 900 000 километров. Квадратное событие тревоги на двух секундах лежит вне будущего светового конуса и отделено пространственноподобным интервалом, равным минус 4,5 на 10 в 11-й степени квадратных километров. Ромбовидное событие тревоги на трех секундах лежит точно на светоподобной границе, а его интервал равен нулю. Круглое событие тревоги на четырех секундах лежит внутри конуса и отделено временеподобным интервалом, равным плюс 6,3 на 10 в 11-й степени квадратных километров. Световая граница достигает станции ровно через три секунды.",
      axes: "Оси положения и времени",
      cone: "Будущий световой конус от события испускания сигнала",
      stationGroup: "Мировая линия станции и три возможных события тревоги",
      position: "Положение x (км)",
      time: "Время t (с)",
      futureCone: "БУДУЩИЙ СВЕТОВОЙ КОНУС",
      coneDetail: "сюда могут прийти сигналы от события испускания",
      lightBoundary: "светоподобная граница",
      station: "СТАНЦИЯ · x = 900 000 км",
      alarm2: "Тревога в 2 с",
      alarm3: "Тревога в 3 с",
      alarm4: "Тревога в 4 с",
      spacelike: "ПРОСТРАНСТВЕННОПОДОБНЫЙ · вне конуса",
      lightlike: "СВЕТОПОДОБНЫЙ · на границе",
      timelike: "ВРЕМЕНЕПОДОБНЫЙ · внутри конуса",
      interval2: "Δs² = −4,5 × 10¹¹ км²",
      interval3: "Δs² = 0",
      interval4: "Δs² = +6,3 × 10¹¹ км²",
      emission: "Испускание сигнала",
      origin: "x = 0, t = 0",
      arrival: "Свет приходит: 3 с",
      scale: "c ≈ 300 000 км/с  ·  300 000 км по горизонтали = 1 с по вертикали",
      tick0: "0",
      tick1: "1",
      tick2: "2",
      tick3: "3",
...
<svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}" role="img" aria-labelledby="diagram-title diagram-description" lang="${language}" xml:lang="${language}">
  ...
  <defs>
    ...
    <style>
      ...
      svg:lang(ru) .event-kind { font-size: 14px; letter-spacing: 0; }
      svg:lang(ru) .cone-detail { font-size: 15px; }
    </style>
  </defs>
